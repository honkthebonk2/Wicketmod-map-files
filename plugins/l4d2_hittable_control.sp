...
public void OnPluginStart()
{
	...
	hVanDamage				= CreateConVar( "hc_van_standing_damage",	"100.0",
											...
											FCVAR_NONE, true, -2.0, false, 0.0 );
	hColdFrontShelfDamage	= CreateConVar( "hc_coldfront_shelf_standing_damage",	"100.0",
											"Damage of hittable shelf on Cold Front to non-incapped survivors.",
											FCVAR_NONE, true, -2.0, false, 0.0 );
...
int HittableDamageFromModel(int entity)
{
	...
	else if (StrEqual(sModelName, "models/props_mall/store_display_waisthigh.mdl", false))
	{
		return hColdFrontShelfDamage.IntValue;
	}
